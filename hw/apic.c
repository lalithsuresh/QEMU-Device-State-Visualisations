...
const VMStateDescription vmstate_apic = {
    ...
    .fields      = (VMStateField []) {
        ...
        VMSTATE_BITFIELD(lvt[APIC_LVT_TIMER], APICState, APIC_LVT_TIMER, APIC_LVT_TIMER_PERIODIC, "APIC_LVT_TIMER_PERIODIC"),
        VMSTATE_BITFIELD(lvt[APIC_LVT_TIMER], APICState, APIC_LVT_TIMER, APIC_LVT_MASKED, "APIC_LVT_MASKED"),
        VMSTATE_BITFIELD(lvt[APIC_LVT_TIMER], APICState, APIC_LVT_TIMER, APIC_LVT_LEVEL_TRIGGER, "APIC_LVT_LEVEL_TRIGGER"),
